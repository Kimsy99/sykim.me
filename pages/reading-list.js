...
export default function ReadingList({ list }) {
  const description =
    "From essays to videos, books and tweets, this page is a collection of learning materials that I enjoy. I add to the list frequently, and will improve sorting and filtering soon.";
  ...
  return (
    <>
      <Head>
        <title>{"Kim's Reading List"}</title>
