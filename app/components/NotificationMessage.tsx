  ...
  return (
    <AnimatePresence>
      {show ? (
        ...
        >
          <div
            className={clsx("prose flex mx-auto w-full max-w-8xl", {
              "justify-end": position === "bottom-right",
              "justify-center": position === "top-center",
            })}
          >
            <div className="bg-gray-800 text-inverse relative p-8 pr-14 max-w-xl rounded-lg shadow-md pointer-events-auto">
